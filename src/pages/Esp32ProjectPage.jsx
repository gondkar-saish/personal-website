  ...
  const components = [
    {
      ...
      image: '/components/esp32Image.png',
      top: '50%',
      left: '50%',
      width: 'w-48 md:w-64',
      zIndex: 40,
    ...
    },
    {
      ...
      image: '/components/oledDisplayImage.png',
      top: '25%',
      left: '80%',
      width: 'w-36 md:w-48',
      zIndex: 30,
    ...
    },
    {
      ...
      image: '/components/dht11Image.png',
      top: '25%',
      left: '20%',
      width: 'w-32 md:w-40',
      zIndex: 30,
    ...
    },
    {
      ...
      image: '/components/pirSensorImage.png',
      top: '60%',
      left: '15%',
      width: 'w-36 md:w-44',
      zIndex: 30,
    ...
    },
    {
      ...
      image: '/components/ldrSensorImage.png',
      top: '15%',
      left: '50%',
      width: 'w-24 md:w-32',
      zIndex: 20,
    ...
    },
    {
      ...
      image: '/components/buzzerImage.png',
      top: '80%',
      left: '35%',
      width: 'w-24 md:w-32',
      zIndex: 30,
    ...
    },
    {
      ...
      image: '/components/relayModuleImage.png',
      top: '75%',
      left: '75%',
      width: 'w-32 md:w-44',
      zIndex: 30,
